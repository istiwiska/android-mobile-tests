...
Mobile.setText(findTestObject('Register/android.widget.EditTextPassword'), 'haiiiiiiiiiiiiiiiiiiiiiiiii', 0)

Mobile.setText(findTestObject('Register/android.widget.EditTextConfirmPassword'), 'haiiiiiiiiiiiiiiiiiiiiiiiii', 0)
