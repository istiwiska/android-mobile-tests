...
Mobile.setText(findTestObject('Register/android.widget.EditTextConfirmPassword'), 'haiiiiiiiiiiiiiiiiiiiiiiiii12', 0)
...
//String text = Mobile.getAttribute(findTestObject('Register/android.widget.TextView - Registration Successful'), 
//    'text', 5)
//
//Mobile.verifyEqual(text, 'Registration Successful')
